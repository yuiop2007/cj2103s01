...
<div class="container">
  <form method="post" class="w3-container w3-card-4 w3-light-grey w3-text-black w3-margin">
      ...
      <input class="w3-radio" type="radio" name="age" value="10대" checked><label>10대</label>&nbsp;
      ...
      <select class="w3-select w3-border" name="job">
      ...
      <select class="w3-select w3-border" name="area">
		...
		<button class="w3-button w3-block w3-section w3-gray w3-ripple w3-padding" onclick="fCheck()">전 송</button>
	</form>
</div>
<p><br/></p>
