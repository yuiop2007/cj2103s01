...
<div class="container">
  ...
  <form name="myform" method="post" enctype="multipart/form-data">
    ...
    <div class="form-group" class="uploadWrap">
      <img src="${ctp}/resources/vote/ready.jpg" width="70px" id="preview-image1"/>
      <input type="file" name="file" id="file1" class="form-control-file border" accept=".jpg,.gif,.png" onchange="setThumbnail(event)"/>
    </div>
	  <hr/>
    <div class="input-group mb-3">
	    <div class="input-group-prepend">
    ...
    <div class="form-group" class="uploadWrap">
      ...
      <input type="file" name="file" id="file2" class="form-control-file border" accept=".jpg,.gif,.png" onchange="setThumbnail(event)"/>
    </div>
	  <hr/>
    <div class="input-group mb-3">
	    <div class="input-group-prepend">
    ...
    <div class="form-group" class="uploadWrap">
      ...
      <input type="file" name="file" id="file3" class="form-control-file border" accept=".jpg,.gif,.png" onchange="setThumbnail(event)"/>
    </div>
	  <hr/>
    <div class="input-group mb-3">
	    <div class="input-group-prepend">
    ...
    <div class="form-group" class="uploadWrap">
      ...
      <input type="file" name="file" id="file4" class="form-control-file border" accept=".jpg,.gif,.png" onchange="setThumbnail(event)"/>
    </div>
	  <hr/>
    <div class="input-group mb-3">
	    <div class="input-group-prepend">
    ...
    <div class="form-group" class="uploadWrap">
      ...
      <input type="file" name="file" id="file5" class="form-control-file border" accept=".jpg,.gif,.png" onchange="setThumbnail(event)"/>
    </div><br/>
	  <hr/>
    ...
    <div class="input-group mb-3">
	    <div class="input-group-prepend">
	      <span class="input-group-text">여섯째그림(연습)</span>
	    </div>
	    <input type="text" class="form-control" name="subTitle" placeholder="여섯째그림">
	  </div>
    <div class="form-group">
    	<input type="file" name="file" id="file6" class="form-control-file border" accept=".jpg,.gif,.png" onchange="setThumbnail(event)"/>
    </div><br/>
    <!-- 여기까지 -->
  ...
  <script>
    // 아래 함수 하나로 처리 가능(앞의 6번째...)...(기존 그림 날리는것이 문제....?)
