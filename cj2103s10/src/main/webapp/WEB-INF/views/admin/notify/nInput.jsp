...
<div class="container">
  ...
  <form name="myform" method="post" class="was-validated">
    <div class="form-group">
      ...
      <input type="text" class="form-control" id="name" name="name" value="${snickname}" readonly/>
      <div class="invalid-feedback">공지사항 올리는 사람을 입력하세요.</div>
    </div>
    <div class="form-group">
      <label for="title">글제목 : </label>
      <input type="text" class="form-control" id="title" name="title" placeholder="공지 제목을 입력하세요." required/>
