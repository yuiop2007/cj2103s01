...
<body>
	...
	<div class="container">
		<form name="qInputform" method="post" action="${ctp}/board/qInput" enctype="multipart/form-data">
			<h6>Q&A 등록</h6>
			<hr />
				...
				<label>카테고리</label><br/>
					<select name="qCate" style="width: 20%;">
						...
						<option value="입금관련">입금관련</option>
						<option value="기타">기타</option>
					</select>
					<br/><br/><br/>
				<label>상세 내용</label>
					<textarea rows="5" cols="50" name="qContent" id="CKEDITOR" required></textarea>
					<script>
				...
				<br/><br/><br/>
				<label>공개여부</label><br/>
					<input type=radio name="qSecret" value="0">공개 &nbsp;&nbsp;&nbsp;
					<input type=radio name="qSecret" value="1" checked>비공개
				<br/><br/><br/>
				<label>비밀번호</label>
